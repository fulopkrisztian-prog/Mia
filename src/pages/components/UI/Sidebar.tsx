          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive 
                  ? "bg-gradient-to-br from-blue-600/40 to-cyan-600/40 border border-blue-500/50"
                  : "hover:bg-slate-800/40 hover:border-slate-700/50"
              )}
              title={tab.label}
            >
              {isActive && (
                <div className="absolute -left-1 top-1/2 transform -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-blue-400 to-cyan-400 rounded-r-full" />
              )}
